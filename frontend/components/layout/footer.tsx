  ...
  const footerLinks = [
    {
      ...
      links: [
        { name: t("products.all"), href: "/products" },
        { name: "Nail Polish", href: "/products?category=nail-polish" },
        { name: "Nail Care", href: "/products?category=nail-care" },
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <I18nLink href="/" className="text-2xl font-bold">
              {t("app.name")}
            </I18nLink>
            <p className="mt-4 text-gray-400 max-w-md">{t("app.tagline")}</p>
            <div className="mt-6">
              ...
              <form className="mt-2 flex sm:max-w-md">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="appearance-none min-w-0 w-full bg-white border border-gray-300 rounded-md py-2 px-4 text-base text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 focus:placeholder-gray-400"
