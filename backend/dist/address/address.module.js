...
const address_validation_controller_1 = require("./address-validation.controller");
...
exports.AddressModule = AddressModule = __decorate([
    (0, common_1.Module)({
        controllers: [address_validation_controller_1.AddressValidationController],
        providers: [address_validation_service_1.AddressValidationService],
        exports: [address_validation_service_1.AddressValidationService],
    })
], AddressModule);
